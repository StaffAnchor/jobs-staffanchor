...
// ---- Industries (extensive list, so profiles are searchable by granular
// industry and Current Industry / Previous Industries can both draw from the
// same taxonomy used elsewhere in the product) ----
...
export const highestQualificationOptions = [
  "High School",
  "Diploma",
  "Bachelor's Degree (B.A. / B.Com / B.Sc.)",
  "B.Tech / B.E. (Engineering)",
  "Master's Degree (M.A. / M.Com / M.Sc.)",
