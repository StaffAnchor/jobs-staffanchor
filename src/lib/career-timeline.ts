...
// merged for scoring, diffed for gaps. Mirrors staffanchor-crm's
// src/lib/career-timeline.ts exactly (same candidates table, same
// career_timeline_resume/career_timeline_profile columns) so scoring and
// gap logic stay identical whether a candidate edits their own timeline
// here or a recruiter edits it in the CRM.
//
...
//   automatically whenever the resume changes (via the CRM's cron sweep,
//   which runs against the same Supabase project regardless of which app
//   the resume was uploaded through).
