...
// Ported verbatim from staffanchor-crm's src/lib/generate-career-timeline-from-resume.ts
// so a candidate who registers/applies here on jobs.staffanchor.com gets the
// same resume-derived Career Timeline + Stability Score as one created
// through the CRM, without waiting for the CRM's twice-weekly cron sweep.
